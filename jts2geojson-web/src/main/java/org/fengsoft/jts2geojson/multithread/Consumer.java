...
public class Consumer implements Runnable {
    ...
    public Consumer(BlockingQueue<TileIndex> queue, OkHttpClient okHttpClient, GlobalMercator mercator, String tileName, String imageTilePath, TileType tileType) {
        this.queue = queue;
