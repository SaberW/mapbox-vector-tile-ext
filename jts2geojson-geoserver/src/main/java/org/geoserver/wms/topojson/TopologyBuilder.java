...
public class TopologyBuilder implements VectorTileBuilder {
    ...
    public byte[] build() throws IOException {
        ...
        for (String layer : this.layers.keySet()) {
            ...
            GeometryColleciton layerCollection = new GeometryColleciton(collection);
    ...
    private GeometryColleciton createGeometryCollection(GeometryCollection geom) {
        ...
        GeometryColleciton collection = new GeometryColleciton(members);
        return collection;
    }
